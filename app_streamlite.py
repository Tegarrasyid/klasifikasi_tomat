...
st.markdown("Aplikasi machine learning untuk klasifikasi tomat termasuk kategori *Ekpor, Lokal Premium, atau Industri*")
...
st.divider()
st.caption("Dibuat dengan 🍅 oleh *Tegar Rasyid Al Aziz*")